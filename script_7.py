# Install qrcode library and create QR codes
import subprocess
import sys
...
try:
    ...
    print("QR code libraries already installed")
except ImportError:
...
def create_qr_code(data, filename, size=10, border=4):
    qr = qrcode.QRCode(
        version=1,
...
# 1. Main portfolio QR code (placeholder URL)
main_url = "https://your-username.github.io/your-portfolio"
qr1 = create_qr_code(main_url, "portfolio-qr-code.png")
qr_codes.append(("Portfolio Website", main_url, qr1))

# 2. LinkedIn profile QR code
linkedin_url = "https://linkedin.com/in/yourusername"
qr2 = create_qr_code(linkedin_url, "linkedin-qr-code.png")
qr_codes.append(("LinkedIn Profile", linkedin_url, qr2))

# 3. GitHub profile QR code
github_url = "https://github.com/yourusername"
qr3 = create_qr_code(github_url, "github-qr-code.png")
qr_codes.append(("GitHub Profile", github_url, qr3))

# 4. Contact email QR code
email_url = "mailto:bathinasivaprasadreddy@gmail.com"
qr4 = create_qr_code(email_url, "email-qr-code.png")
qr_codes.append(("Email Contact", email_url, qr4))

print("✅ QR Codes created successfully!")
for name, url, filename in qr_codes:
    print(f"   📱 {name}: {filename}")

# Create a comprehensive QR code guide
qr_guide = """# QR Code Usage Guide - DevOps Portfolio
...
# Write the QR code guide
with open('qr-code-guide.md', 'w', encoding='utf-8') as f:
    f.write(qr_guide)

print(f"✅ QR code guide created: qr-code-guide.md")
print(f"✅ Total files created: 12")
print(f"✅ QR codes ready for use!")